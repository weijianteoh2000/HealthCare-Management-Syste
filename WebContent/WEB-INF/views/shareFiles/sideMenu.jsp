...
<div class="col-lg-2 bg-white wow fadeIn" data-wow-delay="0.1s">
	<div class="mb-5">
		<div id="side-menu-item" class="d-flex flex-column justify-content-start mt-2 wow fadeIn" data-wow-delay="0.1s">
			<script>
                let contents =[
                    {id:"sidebar-order", name:"Order",image:"//resources/img/booking-page-icon.png",link:"pages/order"},
                    {id:"sidebar-products", name:"Products",image:"//resources/img/application-list-icon.png",link: "pages/product"},
                   ...
                   {id:"sidebar-patient",name:"Patient",image:"//resources/img/edituser-page-icon.png",link: "pages/customer"},
                   {id:"sidebar-pendingBooking",name:"Pending Booking",image:"//resources/img/edituser-page-icon.png",link: "pages/medicalCheckUpPendingList"},
                    {id:"sidebar-orderPending",name:"Order Pending",image:"//resources/img/edituser-page-icon.png",link: "pages/phar_manageOrder"},
                    {id:"sidebar-CheckOrder",name:"Check Order",image:"//resources/img/booking-page-icon.png",link:"pages/cust_manageOrder"},

...
<body>
	...
	<script>
		...
		const graph_sales_category = document.getElementById('myGraph_salesCategory');
		...
		new Chart(chart,
				{
					type : 'doughnut',
					data : {
						labels : [ 'Pregnancy Kit', 'Prescription Drugs', 'Supplement', 'Blood Cholesterol Testing', 'Oral Care',
								],
						datasets : [ {
		...
		new Chart(graph_profit,
				{
					type : 'line',
					data : {
						labels : [ 'January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'October'
								],
						datasets : [ {
							label : 'Line Profit',
							data : [ 1200, 789, 673, 1366, 483, 1234, 789, 989, 189, 1022, 647, 2334 ],
							backgroundColor: [
								'rgba(255, 99, 132, 1)',
								'rgba(54, 162, 235, 1)',
								'rgba(255, 206, 86, 1)',
